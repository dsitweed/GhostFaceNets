...
def GhostNetV1_ky(input_shape=(224, 224, 3), include_top=True, classes=0, width=1.3, strides=2, name="GhostNet"):
    ...
    #The last value in exps which is 512 is the embedding shape
    dwkernels = [3, 5, 3, 5, 3]
    exps = [16, 48, 72, 120, 240]
    outs = [16, 24, 40, 80, 160]
    use_ses = [0, 0.25, 0, 0.25, 0]
    strides = [1, 2, 2, 1, 2]

    # dwkernels = [3, 5, 3, 3, 5, 5]
    # exps = [16, 72, 240, 184, 960, 512]
    # outs = [16, 40, 80, 112, 160, 160]
    # use_ses = [0, 0.25, 0, 0, 0.25, 0.25]
    # strides = [1, 2, 2, 1, 2, 1]
    ...
    dwkernels = [3, 3, 5, 3, 5, 5, 3, 5]
    exps = [16, 48, 72, 184, 240, 480, 672, 960]
    outs = [16, 24, 40, 80, 80, 112, 160, 160]
    use_ses = [0, 0, 0.25, 0, 0.25, 0.25, 0, 0.25]
    strides = [1, 2, 2, 1, 2, 1, 1, 1]
