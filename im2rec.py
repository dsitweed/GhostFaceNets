# Nguồn hướng dẫn: https://github.com/eeric/Face_recognition_cnn/blob/main/code/insightface/README.md

# python3 im2rec.py datasets/vn_celeb/train datasets/vn_celeb_imgs --list --recursive --resize 112 --no-shuffle --num-thread 8
# python3 im2rec.py datasets/vn_celeb/train datasets/vn_celeb_imgs --recursive --pass-through --pack-label --no-shuffle --num-thread 8
# python prepare_data.py -D datasets/vn_celeb

# python3 -c "import tensorflow as tf; print('Num GPUs Available:', tf.config.list_physical_devices('GPU'))"
